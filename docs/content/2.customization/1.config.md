...
Register custom [preprocessors](/customization/preprocessors) that transform prefixed strings in `meta()`.
This is useful for integrating with `vue-i18n` or applying custom string transformations to labels, descriptions, and placeholders.
...
See the [Preprocessors](/customization/preprocessors) documentation for full details and the processor signature.
